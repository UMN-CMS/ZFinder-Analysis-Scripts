...
//=========  (Tue Apr 28 10:48:48 2015) by ROOT version5.34/18
   ...
   Graph_Graph_Graph69->SetMinimum(0.8834094);
   Graph_Graph_Graph69->SetMaximum(1.086481);
   ...
   Graph_Graph_Graph710->SetMinimum(0.7453934);
   Graph_Graph_Graph710->SetMaximum(1.15466);
