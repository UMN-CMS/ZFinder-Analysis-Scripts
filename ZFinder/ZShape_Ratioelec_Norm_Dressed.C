...
//=========  (Tue May 19 14:29:49 2015) by ROOT version5.34/18
   TCanvas *FinalPhiRatio = new TCanvas("FinalPhiRatio", "FinalPhiRatio",4,97,800,900);
   ...
   TH1F *Graph_Graph_Graph141146 = new TH1F("Graph_Graph_Graph141146","",100,0.0006,3.604633);
   Graph_Graph_Graph141146->SetMinimum(0.7);
   Graph_Graph_Graph141146->SetMaximum(1.3);
   Graph_Graph_Graph141146->SetDirectory(0);
   Graph_Graph_Graph141146->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph_Graph141146->SetLineColor(ci);
   Graph_Graph_Graph141146->GetXaxis()->SetTitle("#phi*");
   Graph_Graph_Graph141146->GetXaxis()->SetRange(1,84);
   Graph_Graph_Graph141146->GetXaxis()->SetLabelFont(42);
   Graph_Graph_Graph141146->GetXaxis()->SetLabelOffset(-0.01);
   Graph_Graph_Graph141146->GetXaxis()->SetTitleOffset(1.05);
   Graph_Graph_Graph141146->GetXaxis()->SetTitleFont(42);
   Graph_Graph_Graph141146->GetYaxis()->SetTitle("MC/Data");
   Graph_Graph_Graph141146->GetYaxis()->SetNdivisions(503);
   Graph_Graph_Graph141146->GetYaxis()->SetLabelFont(42);
   Graph_Graph_Graph141146->GetYaxis()->SetTitleOffset(1.2);
   Graph_Graph_Graph141146->GetYaxis()->SetTitleFont(42);
   Graph_Graph_Graph141146->GetZaxis()->SetLabelFont(42);
   Graph_Graph_Graph141146->GetZaxis()->SetLabelSize(0.035);
   Graph_Graph_Graph141146->GetZaxis()->SetTitleSize(0.035);
   Graph_Graph_Graph141146->GetZaxis()->SetTitleFont(42);
   grae->SetHistogram(Graph_Graph_Graph141146);
   ...
   TH1F *Graph_Graph_Graph142147 = new TH1F("Graph_Graph_Graph142147","Graph",100,0.0018,3.18925);
   Graph_Graph_Graph142147->SetMinimum(0.9360717);
   Graph_Graph_Graph142147->SetMaximum(1.051065);
   Graph_Graph_Graph142147->SetDirectory(0);
   Graph_Graph_Graph142147->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph_Graph142147->SetLineColor(ci);
   Graph_Graph_Graph142147->GetXaxis()->SetLabelFont(42);
   Graph_Graph_Graph142147->GetXaxis()->SetLabelSize(0.035);
   Graph_Graph_Graph142147->GetXaxis()->SetTitleSize(0.035);
   Graph_Graph_Graph142147->GetXaxis()->SetTitleFont(42);
   Graph_Graph_Graph142147->GetYaxis()->SetLabelFont(42);
   Graph_Graph_Graph142147->GetYaxis()->SetLabelSize(0.035);
   Graph_Graph_Graph142147->GetYaxis()->SetTitleSize(0.035);
   Graph_Graph_Graph142147->GetYaxis()->SetTitleFont(42);
   Graph_Graph_Graph142147->GetZaxis()->SetLabelFont(42);
   Graph_Graph_Graph142147->GetZaxis()->SetLabelSize(0.035);
   Graph_Graph_Graph142147->GetZaxis()->SetTitleSize(0.035);
   Graph_Graph_Graph142147->GetZaxis()->SetTitleFont(42);
   grae->SetHistogram(Graph_Graph_Graph142147);
   ...
   TH1F *Graph_Graph_Graph143148 = new TH1F("Graph_Graph_Graph143148","Graph",100,0.0018,3.18925);
   Graph_Graph_Graph143148->SetMinimum(0.7736239);
   Graph_Graph_Graph143148->SetMaximum(1.121686);
   Graph_Graph_Graph143148->SetDirectory(0);
   Graph_Graph_Graph143148->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph_Graph143148->SetLineColor(ci);
   Graph_Graph_Graph143148->GetXaxis()->SetLabelFont(42);
   Graph_Graph_Graph143148->GetXaxis()->SetLabelSize(0.035);
   Graph_Graph_Graph143148->GetXaxis()->SetTitleSize(0.035);
   Graph_Graph_Graph143148->GetXaxis()->SetTitleFont(42);
   Graph_Graph_Graph143148->GetYaxis()->SetLabelFont(42);
   Graph_Graph_Graph143148->GetYaxis()->SetLabelSize(0.035);
   Graph_Graph_Graph143148->GetYaxis()->SetTitleSize(0.035);
   Graph_Graph_Graph143148->GetYaxis()->SetTitleFont(42);
   Graph_Graph_Graph143148->GetZaxis()->SetLabelFont(42);
   Graph_Graph_Graph143148->GetZaxis()->SetLabelSize(0.035);
   Graph_Graph_Graph143148->GetZaxis()->SetTitleSize(0.035);
   Graph_Graph_Graph143148->GetZaxis()->SetTitleFont(42);
   grae->SetHistogram(Graph_Graph_Graph143148);
   ...
   TH1F *Graph_Graph_Graph144149 = new TH1F("Graph_Graph_Graph144149","Graph",100,0.0018,3.18925);
   Graph_Graph_Graph144149->SetMinimum(0.8030033);
   Graph_Graph_Graph144149->SetMaximum(1.105594);
   Graph_Graph_Graph144149->SetDirectory(0);
   Graph_Graph_Graph144149->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph_Graph144149->SetLineColor(ci);
   Graph_Graph_Graph144149->GetXaxis()->SetLabelFont(42);
   Graph_Graph_Graph144149->GetXaxis()->SetLabelSize(0.035);
   Graph_Graph_Graph144149->GetXaxis()->SetTitleSize(0.035);
   Graph_Graph_Graph144149->GetXaxis()->SetTitleFont(42);
   Graph_Graph_Graph144149->GetYaxis()->SetLabelFont(42);
   Graph_Graph_Graph144149->GetYaxis()->SetLabelSize(0.035);
   Graph_Graph_Graph144149->GetYaxis()->SetTitleSize(0.035);
   Graph_Graph_Graph144149->GetYaxis()->SetTitleFont(42);
   Graph_Graph_Graph144149->GetZaxis()->SetLabelFont(42);
   Graph_Graph_Graph144149->GetZaxis()->SetLabelSize(0.035);
   Graph_Graph_Graph144149->GetZaxis()->SetTitleSize(0.035);
   Graph_Graph_Graph144149->GetZaxis()->SetTitleFont(42);
   grae->SetHistogram(Graph_Graph_Graph144149);
   ...
   TH1F *Graph_Graph_Graph145150 = new TH1F("Graph_Graph_Graph145150","Graph",100,0.0018,3.18925);
   Graph_Graph_Graph145150->SetMinimum(0.8091179);
   Graph_Graph_Graph145150->SetMaximum(1.105382);
   Graph_Graph_Graph145150->SetDirectory(0);
   Graph_Graph_Graph145150->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph_Graph145150->SetLineColor(ci);
   Graph_Graph_Graph145150->GetXaxis()->SetLabelFont(42);
   Graph_Graph_Graph145150->GetXaxis()->SetLabelSize(0.035);
   Graph_Graph_Graph145150->GetXaxis()->SetTitleSize(0.035);
   Graph_Graph_Graph145150->GetXaxis()->SetTitleFont(42);
   Graph_Graph_Graph145150->GetYaxis()->SetLabelFont(42);
   Graph_Graph_Graph145150->GetYaxis()->SetLabelSize(0.035);
   Graph_Graph_Graph145150->GetYaxis()->SetTitleSize(0.035);
   Graph_Graph_Graph145150->GetYaxis()->SetTitleFont(42);
   Graph_Graph_Graph145150->GetZaxis()->SetLabelFont(42);
   Graph_Graph_Graph145150->GetZaxis()->SetLabelSize(0.035);
   Graph_Graph_Graph145150->GetZaxis()->SetTitleSize(0.035);
   Graph_Graph_Graph145150->GetZaxis()->SetTitleFont(42);
   grae->SetHistogram(Graph_Graph_Graph145150);
...
tex->SetNDC();
   ...
   entry->SetMarkerSize(1);
   entry->SetTextFont(42);
   entry=leg->AddEntry("Graph3","Z #rightarrow ee Pwheg2","P");
   entry->SetLineColor(1);
   entry->SetLineStyle(1);
   entry->SetLineWidth(1);
   ...
   entry->SetMarkerSize(1);
   entry->SetTextFont(42);
   entry=leg->AddEntry("Graph4","Z #rightarrow ee Powheg1","P");
   entry->SetLineColor(1);
   entry->SetLineStyle(1);
   entry->SetLineWidth(1);
