...
//=========  (Tue Apr 28 10:18:27 2015) by ROOT version5.34/18
   ...
   Graph_Graph_Graph69->SetMinimum(0.886982);
   Graph_Graph_Graph69->SetMaximum(1.050026);
   ...
   Graph_Graph_Graph710->SetMinimum(0.7505948);
   Graph_Graph_Graph710->SetMaximum(1.140163);
