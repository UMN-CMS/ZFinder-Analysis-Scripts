...
//  BinMigration->GetYaxis()->SetRangeUser(0.001,3.2);
  ...
  BinMigration->GetZaxis()->SetTitleOffset(-0.002);
  ...
  if (madgraph){
    TCanvas* BinM_M = new TCanvas("BinM_M","BinM_M",1000,900);
    BinM_M->cd();
    // BinM_M->SetLogx();
    // BinM_M->SetLogy();
    BinM_M->SetLogz();
    ...
    BinM_M->SaveAs((plotname+"res.png").c_str());
    TCanvas* Dp_M = new TCanvas("Dp_M","Dp_M",900,900);
    Dp_M->cd();
    Dp_M->SetLogy();
    Dphistar->Draw();
    mark.DrawLatex(0.19,0.80,"MadGraph");
    Dp_M->SaveAs((plotname+"Dphistar.png").c_str());
    TCanvas* Dy_M = new TCanvas("Dy_M","Dy_M",800,900);
    Dy_M->cd();
    Dy_M->SetLogy();
    Dy->Draw();
    mark.DrawLatex(0.19,0.80,"MadGraph");
    Dy_M->SaveAs((plotname+"Dy.png").c_str());
    Dy_M->Delete();
  }
  else{
    TCanvas* BinM_P = new TCanvas("BinM_P","BinM_P",1000,900);
    BinM_P->cd();
    // BinM_P->SetLogx();
    // BinM_P->SetLogy();
    BinM_P->SetLogz();
    ...
    BinM_P->SaveAs((plotname+"res.png").c_str());
    BinM_P->Delete();
    ...
    Dphistar->Draw();
    mark.DrawLatex(0.19,0.80,"Powheg");
    Dp_P->SaveAs((plotname+"Dphistar.png").c_str());
    Dp_P->Delete();
    ...
    Dy->Draw();
    mark.DrawLatex(0.19,0.80,"Powheg");
    Dy_P->SaveAs((plotname+"Dy.png").c_str());
    Dy_P->Delete();
  }
...
void NTupleBinM(){
  for (int elec=1; elec<2; elec++){
    ...
    BinMigration_MM->SaveAs((plotname+"MM.png").c_str());
    // BinMigration_MM->SaveAs((plotname+"MM.C").c_str());
BinMigration_MM->Delete();
    ...
    // // mark.SetTextColor(1);
    mark.DrawLatex(0.19,0.17,"Unfolded using MadGraph");
    BinMigration_M1M2->SaveAs((plotname+"M1M2.png").c_str());
    // BinMigration_M1M2->SaveAs((plotname+"M1M2.C").c_str());
BinMigration_M1M2->Delete();
    ...
    BinMigration_PP->SaveAs((plotname+"PP.png").c_str());
    // BinMigration_PP->SaveAs((plotname+"PP.C").c_str());
BinMigration_PP->Delete();
    ...
    // // mark.SetTextColor(1);
    mark.DrawLatex(0.19,0.17,"Unfolded using Powheg");
    BinMigration_P1P2->SaveAs((plotname+"P1P2.png").c_str());
    // BinMigration_P1P2->SaveAs((plotname+"P1P2.C").c_str());
BinMigration_P1P2->Delete();
    ...
    // mark.DrawLatex(0.19,0.80,chi.c_str());
    mark.DrawLatex(0.19,0.17,"Unfolded using MadGraph");
    BinMigration_MP->SaveAs((plotname+"MP.png").c_str());
    // BinMigration_MP->SaveAs((plotname+"MP.C").c_str());
BinMigration_MP->Delete();
    ...
    // mark.DrawLatex(0.19,0.80,chi.c_str());
    mark.DrawLatex(0.19,0.17,"Unfolded using Powheg");
    BinMigration_PM->SaveAs((plotname+"PM.png").c_str());
    // BinMigration_PM->SaveAs((plotname+"PM.C").c_str());
    BinMigration_PM->Delete();
  }
}
